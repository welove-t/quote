  ...
  return (
    <div>
      ...
      <div className="container text-center">
        ...
        <div className="relative m-auto sm:w-[360px] md:w-[360px]">
          <div className="group mx-auto mt-4  mb-4 h-96 cursor-pointer py-4 transition-all delay-700">
            {/* カード裏 */}
            <Box
              className="absolute left-0 top-0 flex h-96 w-[360px] items-center justify-center whitespace-normal rounded-lg bg-gray-800 text-center font-bold transition-all duration-500 backface-hidden group-hover:rotate-y-180"
            ...
            {/* カード表 */}
            <Box
              className="absolute left-0 top-0 flex h-96 w-[360px] items-center justify-center whitespace-normal rounded-lg border-hidden text-center font-bold transition-all duration-500 rotate-y--180 backface-hidden group-hover:rotate-y-0"
              sx={() => ({ backgroundColor: "#f1f4f7" })}
            >
              <Blockquote
                cite={`- ニーチェ`}
